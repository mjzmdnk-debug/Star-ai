...
let changed = false;
const emblem = '/assets/star-ai-world.svg?v=6';
for (const oldSrc of ['/assets/star-ai-world.svg?v=3','/assets/star-ai-world.svg?v=4','/assets/star-ai-world.svg?v=5','/assets/star-ai-world.svg','/assets/star-ai-emblem.svg?v=2','/assets/star-ai-emblem.jpg?v=1','/assets/star-ai-emblem.jpg?v=2','/assets/star-ai-emblem.jpg?v=3','/assets/star-ai-emblem.jpg?v=4']) {
  if (html.includes(oldSrc)) { html = html.replaceAll(oldSrc, emblem); changed = true; }
}

if (!html.includes('data-star-premium="v5"')) {
  const script = String.raw`<style data-star-premium="v5">
...
console.log('STAR AI premium landing typography and robust emblem rendering enabled.');
