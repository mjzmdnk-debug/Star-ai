...
let changed = false;
const emblem = '/assets/star-ai-emblem.jpg?v=4';
for (const oldSrc of ['/assets/star-ai-world.svg?v=3','/assets/star-ai-world.svg?v=4','/assets/star-ai-world.svg','/assets/star-ai-emblem.svg?v=2','/assets/star-ai-emblem.jpg?v=1','/assets/star-ai-emblem.jpg?v=2','/assets/star-ai-emblem.jpg?v=3']) {
  if (html.includes(oldSrc)) { html = html.replaceAll(oldSrc, emblem); changed = true; }
}

if (!html.includes('data-star-premium="v4"')) {
  const script = String.raw`<style data-star-premium="v4">
...
.hero-brand-logo{object-fit:cover!important;border-radius:0!important;position:relative;z-index:2;box-shadow:none!important;mix-blend-mode:screen!important;filter:drop-shadow(0 0 30px rgba(96,66,220,.3))!important;animation:starReveal .9s ease both,starBreathe 5s ease-in-out 1s infinite}
...
console.log('STAR AI premium landing typography and blended emblem enabled.');
