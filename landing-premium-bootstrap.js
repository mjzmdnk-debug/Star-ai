...
let changed = false;
const emblem = '/assets/star-ai-emblem.svg?v=2';
for (const oldSrc of ['/assets/star-ai-world.svg?v=3','/assets/star-ai-world.svg?v=4','/assets/star-ai-world.svg','/assets/star-ai-emblem.jpg?v=1']) {
  if (html.includes(oldSrc)) { html = html.replaceAll(oldSrc, emblem); changed = true; }
}

if (!html.includes('data-star-premium="v2"')) {
  const script = String.raw`<style data-star-premium="v2">
...
console.log('STAR AI premium landing polish v2 enabled.');
