...
if (!server.includes('STAR_AI_WEB_RESEARCH_V1')) {
  ...
  if (!endpoint.includes('needsWebResearch')) throw new Error('STAR_AI_WEB_RESEARCH_V1: research detection injection failed');
