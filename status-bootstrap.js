...
(() => {
  ...
  function requestKind(url){const value=String(url||'');if(value.includes('/api/image-edit'))return['edit','✦ يعدّل الصورة الآن'];if(value.includes('/api/chat'))return['think','✦ يفكّر ويكتب الآن'];return null}
