...
(() => {
  ...
  function requestKind(url){const value=String(url||'');if(value.includes('/api/image-edit'))return['edit','✦ Görsel düzenleniyor'];if(value.includes('/api/chat'))return['think','✦ Düşünüyor ve yazıyor'];return null}
